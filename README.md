...
## Health Memo
 ...
 Health Memo is a app that offers a lot...
  
 ![](https://img.shields.io/badge/TypeScript-323330?style=for-the-badge&logo=typescript&logoColor=0000FF) 
...
We were motivated by the Users to see a widespread issue in health care: sharing routine updates with your primary care provider can be a terrible user experience. In order to create a reliable, approachable, and practical solution to keep track of your health, we wanted to use already existing technology and effortlessly combine them. Those suffering from one or more chronic conditions will find this to be extremely beneficial. 
